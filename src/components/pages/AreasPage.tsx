...
import {
  ...
  getAreaFinancialSummaries,
  type AreaFinancialSummary,
} from "@/lib/db/areas";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div className="field">
            ...
            <div className="muted" style={{ fontSize: 11, marginTop: 4 }}>
              Short uppercase code used in customer IDs (e.g. BT, AMT, GT)
            </div>
          </div>
          <div className="field">
            <label>Type</label>
            <select
              ...
              onChange={(e) =>
                setForm((f) => ({
                  ...f,
                  type: e.target.value as "garrison" | "civilian",
                }))
              }
            >
...
function AreaCard({
  ...
  financial?: AreaFinancialSummary;
  onEdit: () => void;
}) {
  ...
  return (
    <div className="card area-card lift">
      ...
      >
        {[
          { label: "Expected", value: financial?.expectedRevenue ?? 0 },
          { label: "Received", value: financial?.receivedRevenue ?? 0 },
          { label: "Pending", value: financial?.pendingRevenue ?? 0 },
        ].map((item) => (
          <div
            key={item.label}
            style={{
    ...
    <div className="page">
      <div className="page-header">
        <div>
          <h1>Areas & Sectors</h1>
          <p>
            {areas.length} service areas · {garrisonAreas.length} garrison ·{" "}
            {civilianAreas.length} civilian · {totalCustomers} customers
          </p>
        </div>
      ...
      {areas.length === 0 && (
        ...
        >
          <div style={{ fontSize: 14 }}>
            No areas yet — click &ldquo;Add Area&rdquo; to create one.
          </div>
        </div>
      )}
        ...
        <div className="card-head">
          ...
          <div className="legend">
            ...
            <div className="item">
              <span
                className="sw"
                style={{ background: "var(--green)", borderRadius: "50%" }}
              />
              Civilian
            </div>
          </div>
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    height: 14,
                    background:
                      a.type === "garrison" ? "var(--blue)" : "var(--green)",
                  }}
                />
