...
export type IconName =
  ...
  | 'checkCircle' | 'edit' | 'eye' | 'phone' | 'home' | 'mail' | 'key' | 'download'
  | 'arrowUp' | 'arrowDown' | 'arrowRight' | 'trend' | 'clock' | 'mapPin' | 'wrench'
  | 'percent' | 'layers' | 'chevronLeft' | 'chevronRight' | 'logout' | 'signal' | 'help'
  | 'fileText' | 'refresh' | 'x' | 'externalLink' | 'zap' | 'ban' | 'navArrow'
  | 'eyeOff' | 'copy' | 'trash' | 'tv' | 'menu';
...
const IconSet: Record<string, React.ReactNode> = {
  ...
  alertTri: <><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><path d="M12 9v4"/><path d="M12 17h.01"/></>,
  ...
  navArrow: <><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>,
...
export default function Icon({ name, size = 18, stroke = 1.75, style }: IconProps) {
