...
REVOKE ALL ON FUNCTION public.record_bill_payment(uuid, integer, uuid, text, text, timestamp with time zone, text, text, text) FROM public;
REVOKE EXECUTE ON FUNCTION public.record_bill_payment(uuid, integer, uuid, text, text, timestamp with time zone, text, text, text) FROM anon;
GRANT EXECUTE ON FUNCTION public.record_bill_payment(uuid, integer, uuid, text, text, timestamp with time zone, text, text, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.record_bill_payment(uuid, integer, uuid, text, text, timestamp with time zone, text, text, text) TO service_role;
